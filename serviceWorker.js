...
if (self.URLS_TO_CACHE && self.URLS_TO_CACHE.length > 0) {
    ...
    const precacheManifest = self.URLS_TO_CACHE.map(url => ({
        url: url,
        revision: 'release-2026-03-27-11.11/+0100'
    }));
...
self.addEventListener('activate', event => {
    event.waitUntil((async () => {
        ...
        console.log('Service Worker active! Version: https://github.com/asterics/Asterics-AAC/releases/tag/release-2026-03-27-11.11/+0100');
    })());
});
